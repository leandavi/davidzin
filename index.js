		...
		try {
			...
			mess = {
				...
				only: {
					...
					mod: '[❗] ESTE PEDIDO É ESPECÍFICO PARA USUARIO MOD LEAN BOT*',
					benned: 'Você para a banda, por favor, contate o proprietário para abrir sua banda',
					ownerG: '[❗] DAVID? Este é um recurso especial para o DAVID ❌',
					ownerB: '[❗] DAVID? Este é um recurso especial para o DAVID ❌',
					userB: `──「 LISTA 」──\nOlá Kak !\nDesculpe, irmã. Você não está registrado como amigo de DAVID. Registre-se para fazer amizade com o bot LEAN por meio, \n\nCommand : ${prefix}daftar nama|idade\nExemplo : ${prefix}daftar LEANZIN|17\n\n──「 LEAN BOT 」──`,
			...
			const ownerNumber = ["5571996452136@s.whatsapp.net"] // replace this with your number
			const mod = [ownerNumber,"5571996452136@s.whatsapp.net"]//ubah nomor lo
			const adminbotnumber = ["5571996452136@s.whatsapp.net"]//ubah nomor lo
			const frendsowner = ["5571996452136@s.whatsapp.net"]//ubah nomor lo
			const premium = ["5571996452136@s.whatsapp.net","15136766782@s.whatsapp.net","558981427448@s.whatsapp.net","12792033668@s.whatsapp.net","5514991357606@s.whatsapp.net","558981246187@s.whatsapp.net","15135974358@s.whatsapp.net","19252046906@s.whatsapp.net","557182198257@s.whatsapp.net","556999732506@s.whatsapp.net"] 
...
break
				...
				case 'wibu':
                   ...
                   break
					case 'totaluser':
					if (!isOwner) return reply(mess.only.ownerB)    
					teks = `\`\`\`╭────*「 *TOTAL DE USUÁRIOS LEAN BOT 👑* 」\n\`\`\``
					no = 0
...
// recursos anime, random @Causs domina vida
          ...
          reply('Espere..')
				...
				case 'walpaperanime':
					...
					break
					case 'dado':    
					if (!isPremium) return reply('Você não é um Membro Premium, entre em contato com o DAVIDZIN ou digite *.Daftarvip* para adquirir o acesso Premium!' ,text, { quoted: mek })
				...
				if (!isUser) return reply(mess.only.userB)
					...
					client.sendMessage(from, sa, image, { quoted: mek, caption: '*╭────*「 *PREMIUM USER👑* 」\n*│+ wa.me/5571996452136/*╰──────*「 * DAVIDZIN* 」*────*\n\n*_SE QUER SER UM USUÁRIO PREMIUM DO LEAN BOT_*\n*_Ketik #daftarvip*' })
					break
					case 'cekmod': 
